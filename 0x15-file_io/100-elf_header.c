 ...
 * @e_ident: A pointer to an array that contains ELF magic number.
 *
 * Description: The magic number are separated by spaces.
 */
void print_magic(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: A pointer to an array that contains ELF version.
 */
void print_version(unsigned char *e_ident)
{
	printf("  Version:                           %d",
...
/**
 * main - Display information that contained in the
