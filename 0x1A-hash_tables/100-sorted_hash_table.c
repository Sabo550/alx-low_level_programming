...
/**
 * shash_table_create - create shash table with a given size
 *
...
/**
 * add_n_shash - add node at the beginning of shash at a given index
 *
...
/**
 * add_i_shash - add a node on the DLL of the shash table
 *
...
/**
 * shash_table_print - print the keys and values of the shash table
 *
 * @ht: pointer to the shash table
 * Return: no return
 */
...
/**
 * shash_table_print_rev - print the keys and values of the shash table
 * in reverse
 *
 * @ht: pointer to shash table
 * Return: no return
